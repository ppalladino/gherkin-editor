...
const modelNameSingular = 'StepTemplate'
  ...
  return (
    <DialogRoot lazyMount open={isOpen} onOpenChange={(e) => onOpenChange(e.open)}>
      <DialogContent backgroundColor={"brand.500"}>
        ...
        <DialogBody>
          Do you really want to delete {modelNameSingular}: <Text as="span" fontWeight="bold" color={"brand.highlight"}>{model?.title || "Null"}</Text>?
        </DialogBody>
        <DialogFooter>
